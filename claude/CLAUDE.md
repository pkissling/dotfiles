...
* Keep code comments to a minimum. Do not narrate what the code does or add comments out of habit. Only write a comment when you want to emphasize a point, such as a non-obvious reason, a subtle pitfall, or an intentional deviation from the expected approach.
